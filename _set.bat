...
if "%ELEVATED%" == "" (
    if "%GITBRANCH%" == "" (
        ...
        prompt $E[38;5;240m%CURTIME%^|$E[38;5;75m%PARENT_FOLDER%$E[0m[$E[38;5;229m%GITBRANCH%%GITSTATUS%$E[0m]$G$S
    )
) else (
    if "%GITBRANCH%" == "" (
        prompt $E[38;5;240m%CURTIME%^|$E[38;5;203m%PARENT_FOLDER%$G$E[0m$S
    ) else (
        prompt $E[38;5;240m%CURTIME%^|$E[38;5;203m%PARENT_FOLDER%$E[0m[$E[38;5;229m%GITBRANCH%%GITSTATUS%$E[0m]$G$S
    )
)
