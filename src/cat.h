// MODULE: cat
// Purpose : file printer with syntax highlighting — language detection, colorize per line, delegates images/video
// Exports : enum class lang | detect_lang() colorize_line() cat()
// Depends : common.h, image.h (cat_image is_image_ext), video.h (cat_video is_video_ext)
