// MODULE: editor
// Purpose : line editor — input loop, cursor, multiline, history nav, hint display, tab, paste, redraw
// Exports : struct editor | find_hint() redraw() readline() | term_width() term_height()
...
// Raw input loop: reads INPUT_RECORDs and drives the full editor state machine.
